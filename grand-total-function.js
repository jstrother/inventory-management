// imported into inventory-constructor.js to reduce code-reading troubles

function grandTotal (type) {
...
// take above totals and display them in Inventory table using the following headers:
